    ...
    <div className="space-y-10 sm:space-y-14 md:space-y-16 pb-12">
      {error && !loading && (
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-4">
          <ErrorState
            title="Unable to Load Groceries"
            message="We encountered an issue loading products and categories. Please try again."
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-4 sm:pt-6">
        <div className="relative rounded-3xl overflow-hidden bg-gradient-to-br from-brand-900 via-brand-800 to-emerald-950 text-white shadow-xl min-h-[420px] sm:min-h-[480px] flex items-center">
          ...
          <div className="relative z-10 grid grid-cols-1 lg:grid-cols-12 gap-8 items-center p-5 sm:p-10 lg:p-14 w-full">
            <div className="lg:col-span-7 space-y-4 sm:space-y-6 text-center lg:text-left">
              ...
              <div className="flex flex-wrap items-center justify-center lg:justify-start gap-3 pt-2">
                <Link href="/products" className="inline-block">
                  <Button
                    ...
                    className="shadow-lg shadow-accent-600/30 w-full sm:w-auto"
                  >
                    Shop Now
                  </Button>
                </Link>
                <Link href="/offers" className="inline-block">
                  <Button
                    variant="outline"
                    size="lg"
                    className="bg-white/10 hover:bg-white/20 text-white border-white/20 backdrop-blur-xs w-full sm:w-auto"
                  >
              ...
              {/* Trust micro-badges */}
              <div className="flex flex-wrap items-center justify-center lg:justify-start gap-3 sm:gap-6 pt-4 text-xs font-medium text-slate-300">
            ...
            <div className="lg:col-span-5 relative flex justify-center">
              <div className="relative w-full max-w-md aspect-square rounded-3xl overflow-hidden border border-white/15 shadow-2xl">
                ...
                <div className="absolute bottom-3 sm:bottom-4 left-3 sm:left-4 right-3 sm:right-4 bg-white/95 backdrop-blur-md rounded-2xl p-3 sm:p-3.5 shadow-lg border border-slate-100 flex items-center justify-between text-slate-800 gap-2">
                  <div className="min-w-0">
                    <span className="text-[10px] font-extrabold uppercase tracking-wider text-brand-700 bg-brand-100 px-2 py-0.5 rounded-md">
                      Fresh Harvest
                    </span>
                    <h4 className="text-xs font-bold text-slate-900 mt-1 truncate">California Organic Hass Avocados</h4>
                    <p className="text-[11px] text-slate-500 truncate">Peak season freshness • Ready in 15 mins</p>
                  </div>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
          {/* Banner 1 */}
          <div className="relative rounded-3xl overflow-hidden bg-gradient-to-r from-amber-500 to-orange-600 text-white p-5 sm:p-8 flex flex-col justify-between min-h-[200px] shadow-card group">
            ...
            <div className="relative z-10 pt-4">
              <Link href="/products?category=cat-dairy-breakfast">
                <span className="inline-block px-4 py-2 rounded-xl bg-white text-orange-600 text-xs font-bold shadow-md hover:bg-orange-50 transition-colors">
                  Explore Deals →
                </span>
              </Link>
            </div>
          ...
          {/* Banner 2 */}
          <div className="relative rounded-3xl overflow-hidden bg-gradient-to-r from-emerald-600 to-teal-700 text-white p-5 sm:p-8 flex flex-col justify-between min-h-[200px] shadow-card group">
            <div className="relative z-10 max-w-xs space-y-2">
              <span className="inline-block bg-white/20 backdrop-blur-xs text-white text-[10px] font-extrabold uppercase tracking-widest px-2.5 py-1 rounded-lg">
            ...
            <div className="relative z-10 pt-4">
              <Link href="/products?category=cat-fruits-veg">
                <span className="inline-block px-4 py-2 rounded-xl bg-white text-emerald-700 text-xs font-bold shadow-md hover:bg-emerald-50 transition-colors">
                  Shop Farm Fresh →
                </span>
              </Link>
            </div>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="rounded-3xl bg-white border border-slate-100 p-6 sm:p-10 shadow-card grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8 text-center">
